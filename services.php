 ...
 <div style="position: relative;top:50px; text-align: center;width: 800px;height: 300px; left: 250px;">
    <!-- ################################################################################################ -->
          ...
          <article>
            ...
            <font size="50px" style="position: relative;top:0px; left: 20px;"> HOMEKART SERVICES</font>
            
            <!-- contact details  -->
            
            <P style="text-align: center;" >
            <div style="postion: relative;top:50px; left:500px;">
            <h2> Kitchen, Bathroom and Laundry Remodelling :</h2> Thinking about remodelling your kitchen, bathrooms and laundry? As one of the leading complete renovation company we deliver—high quality, hassle free functional and practical renovations that are completed in 4 weeks.
