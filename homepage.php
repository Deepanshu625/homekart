  ...
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_left">
      <ul>
        ...
        <li><i class="fa fa-envelope-o"></i> homekart@domain.com</li>
      </ul>
    </div>
    <div class="fl_right">
      <ul>
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="bgded overlay" style="background-image:url('photo/home.jpg');">
      ...
      <ul class="slides">
        ...
        <li>
          <article>
            ...
            <!--<h3 class="heading">WELCOME TO HOMEKART</h3>-->
            <p>Improve your home from the ground up.<br>A to Z Home Rennovation<br>Looking for home renovation builders? Let Refresh Renovations deliver the renovation of your dreams – on time and within your budget.</p>
            <footer>
              <ul class="nospace inline pushright">
                <li><a class="btn" href="about.php">About Us</a></li>
                <li><a class="btn inverse" href="services.php">Services</a></li>
