...
<div class="top"><ul>
 ...
 <div class="up" >
  ...
  <form id="form1" name="form1" method="post" action="paste_it.php?id='Carpainter'" onsubmit="return validate()">
  	<fieldset>
  	<legend align="center"><font size="6px" color="black" ><h3>[Book A Painter Here]</h3></font></legend>
    <center>
...
<!-- Footer start
    ...
    <div align="center">
      ...
      <p  align="center" class="style9 style5">Copyright ©2017 All Right Reserved . HOMEKART a rennovation Company.</p>
