...
<div class="top"><ul>
 ...
 <div class="up" >
  ...
  <form id="form1" name="form1" method="post" action="paste_it.php?id='Carpainter'" onsubmit="return validate()">
  	<fieldset>
  	<legend align="center"><font size="6px" color="black" ><h3>[Book A Carpainter Here]</h3></font></legend>
    <center>
...
<!-- Footer start 
    ...
    <div align="center">
      ...
      ######################3 <p><a href="#"><img src="img/facebook.png" alt="facebook" width="60" height="60" /><img src="img/youtube.png" alt="youtube" width="60" height="60"></a> -->
