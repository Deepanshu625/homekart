...
<body style="background:url('photo/imagess.jpg');background-repeat:none;">
    ...
    <div class="container">
      ...
      <div class="col-md-5  toppad  pull-right col-md-offset-3 ">
       ...
       <br>
        <p class=" text-info"><font color="black"><?php echo date("Y-m-d h:i:sa") ;?></font></p>
        </div>
      </div>
            ...
            <div class="panel-body">
              <div class="row">
                ...
                <div class=" col-md-9 col-lg-9 "> 
                  ...
                  <a href="#" class="btn btn-primary">Yes, I am Taking the task</a>
                  <a href="#" class="btn btn-primary">Task completed</a>
                </div>
              </div>
            </div>
